 ...
 * This is the customer's own receipt of what they asked for and when, kept on
 * their phone, which is as much as the app can honestly show.
 */
export const OrdersProvider = ({ children }: { children: ReactNode }) => {
  ...
  const record = useCallback((order: NewSentOrder & { id: string }) => {
